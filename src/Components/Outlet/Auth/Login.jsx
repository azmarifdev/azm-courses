...
const Login = () => {
    ...
    const { handleGoogle, signInEmail, handleGitHub, handleReset } =
        ...
        <div className="grid md:grid-cols-2 mx-auto h-3/4 items-center gap-y-8 px-10 py-5 mt-5 mb-16">
            ...
            <div className="mx-auto">
                <div className="flex flex-col w-full max-w-md px-4 py-8 bg-gray-900 rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
                    <div className="self-center mb-4 text-xl font-light text-white sm:text-2xl dark:text-white">
                        Login To Your Account
                    </div>
                    <div className="flex items-center justify-center mb-3">
                        <Link
                            to="/signup"
                            className="inline-flex items-center text-xs font-semibold text-center text-white hover:text-gray-300 dark:text-gray-100 dark:hover:text-white">
                            <span className="ml-2">
                    ...
                    <div className="mt-8">
                            ...
                            <div className="flex items-center mb-6 -mt-4">
                                <div className="flex ml-auto">
                                    <Link
                                        ...
                                        className="inline-flex text-xs font-thin text-white sm:text-sm dark:text-gray-100 hover:text-gray-300 dark:hover:text-white">
                        ...
                        <div className="flex items-center justify-center mt-3">
                            <Link
                                to=""
                                className="inline-flex items-center text-xs font-semibold text-center text-orange-600 dark:text-gray-100 dark:hover:text-white">
